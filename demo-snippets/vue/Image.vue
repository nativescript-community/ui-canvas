...
<script lang="ts">
import { BitmapShader, CanvasView, Matrix, Paint, Style, TileMode, createRect } from '@nativescript-community/ui-canvas';
import { Frame, ImageSource, TouchGestureEventData, knownFolders, path } from '@nativescript/core';
...
export default class Image extends Vue {
    ...
    onDraw(event: { canvas }) {
        try {
            ...
            matrix.postScale(2, 2, this.touchX, this.touchY);
